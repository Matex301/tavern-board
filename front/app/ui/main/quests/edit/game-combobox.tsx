...
export default function GameCombobox({game, setGame}: {game: GameSelect, setGame: Dispatch<GameSelect>}) {
    const [selected, setSelected] = useState<GameSelect>(game);
    ...
    const load = async (signal: AbortSignal) => {
        ...
        let found = member.find(obj => {return obj["@id"] === game["@id"]});
        if(found) {
            setSelected(found);
        }
