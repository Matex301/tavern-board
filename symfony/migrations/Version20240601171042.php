 ...
 */
final class Version20240601171042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, min_players INT DEFAULT NULL, max_player INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quest (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', creator_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', game_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', tavern_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, max_players INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', start_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', end_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_4317F81761220EA6 (creator_id), INDEX IDX_4317F817E48FD905 (game_id), INDEX IDX_4317F817416D7217 (tavern_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavern (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, website VARCHAR(255) DEFAULT NULL, phone VARCHAR(15) DEFAULT NULL, address_street VARCHAR(80) NOT NULL, address_city VARCHAR(80) NOT NULL, address_country VARCHAR(80) NOT NULL, address_latitude DOUBLE PRECISION NOT NULL, address_longitude DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', username VARCHAR(180) NOT NULL, email VARCHAR(320) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', roles JSON NOT NULL, password VARCHAR(255) NOT NULL, verified TINYINT(1) NOT NULL, banned TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('INSERT INTO tavern (id, name, website, phone, address_street, address_city, address_country, address_latitude, address_longitude) VALUES (0x018ED86DE18D75529AEB5EC34042A5D2, \'Shop Gracz\', \'shopgracz.pl\', \'608 195 190\', \'Bolesława Limanowskiego 16\', \'Kraków\', \'Poland\', 50.0448721, 19.9528476);');
        $this->addSql('INSERT INTO tavern (id, name, website, phone, address_street, address_city, address_country, address_latitude, address_longitude) VALUES (0x018FBF6C58747CE58AED4B0599C8DE18, \'Vanaheim\', \'vanaheim.pl\', \'12 352 39 80\', \'Lubicz 34/6\', \'Kraków\', \'Poland\', 50.0654086, 19.952754);');
        ...
        $this->addSql('INSERT INTO quest (id, creator_id, game_id, tavern_id, title, description, image, max_players, created_at, start_at, end_at) VALUES (0x018EF3BABC967728839BCAE04BF30646, 0x018EF2ABB0F37EF7939DC632878C1AD8, 0x018F77744262738A882B5DD85961E66A, 0x018ED86DE18D75529AEB5EC34042A5D2, \'Pathfinder\', \'Zagrajmy razem w coś fajnego\', null, 6, \'2024-04-19 00:21:25\', \'2024-04-19 00:15:53\', \'2024-04-19 00:18:53\');');
